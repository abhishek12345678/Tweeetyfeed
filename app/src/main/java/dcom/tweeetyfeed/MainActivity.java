...
public class MainActivity extends AppCompatActivity {
    ...
    public void manageurmoney(View view)
    {
        Intent newapps=getPackageManager().getLaunchIntentForPackage("dcom.manageurmoney");
        startActivity(newapps);
    ...
    public void calltoAction(View view)
    {
        ...
        Uri ref=Uri.parse("tel:9646431257");
        i.setData(ref);
        startActivity(i);
    }
